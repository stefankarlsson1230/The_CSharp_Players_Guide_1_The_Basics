WriteLine("What is C#? - It's a general-purpose programming language.");
WriteLine("Why learn to code? - To be able to create games in Unity, create webapps with Blazor, and perhaps to get a job.");
